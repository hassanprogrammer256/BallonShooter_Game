...
# here we are setting the size of the game screen
width = 700
height = 600
display = pygame.display.set_mode((width, height))
pygame.display.set_caption("raymond`s real time - Balloon Shooter Game")
clock = pygame.time.Clock()

margin = 100
lowerBound =40 # this is the space to count the ballons bursted

score = 0


#here we are setting the colors to be used using their hexacodes
white = (230, 230, 230)
lightBlue = (4, 27, 96)
red = (231, 76, 60)
...
#specifying the font to be used in the game
font = pygame.font.SysFont("Arial", 25)
random_change =random.randint(150,4500)

#in this class, we are designing the baloons,ie giving them the x and y widths, etc
class Balloon:
    def __init__(self, speed):
        ...
        self.angle = 90
        self.speed =-speed
        self.proPool= [1,1,1,0,0,0,-1,-1,-1]
        self.length = random.randint(50, 100)
        self.color = random.choice([red, green, purple, orange, yellow, blue])
        

        #this function is to detect the movement of the baloon according to its propool variable
    def move(self):
...
def showScore():
    ...
    display.blit(scoreText, (0, height - lowerBound ))
